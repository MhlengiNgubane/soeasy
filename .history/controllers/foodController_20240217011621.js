...
module.exports = {
    addFood: async (req, res) => {
        const { title, foodTag, foodType, category, code, restaurant, description, time, price, additives, imageUrl} = req.body;

        if( !title || !foodTag || !foodType || !category || !code || !restaurant || !description || !time || !price || !additives || imageUrl) {
